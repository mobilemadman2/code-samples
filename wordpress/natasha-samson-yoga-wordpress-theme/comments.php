...
<section id="comments" class="col-3">
<?php 
if ( have_comments() ) : 
...
?>
<section id="comments-list" class="comments col-content">
...
$args = array(
  ...
  'comment_notes_after' => '<p class="form-allowed-tags"><small>basic html tags are allowed</small></p>',
);
