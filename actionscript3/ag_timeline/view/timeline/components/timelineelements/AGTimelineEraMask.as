package net.believecollective.ag2010.view.timeline.components.timelineelements {
	 ...
	 * @author Marianne
	 */
	public class AGTimelineEraMask extends AGTimeLineElementsBase {
		
		/// just a rectangle the entire size of the era ... used for mask, BG and tint overlay
		
		public static const NAME : String = "AGTimelineEraMask";
		
		public function AGTimelineEraMask(arg_oVO: AGEventVO) {
			super(arg_oVO);
		}
